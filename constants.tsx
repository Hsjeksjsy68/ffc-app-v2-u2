...
export const TacticsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const PLAYER_PROFILE_NAV_LINK: NavLink = { name: 'My Profile', icon: UserCircleIcon };

export const TACTICS_NAV_LINK: NavLink = { name: 'Tactics', icon: TacticsIcon };